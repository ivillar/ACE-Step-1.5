...
class GenerationParams:
    ...
    cot_bpm: int | None = None
    cot_keyscale: str = ""
    cot_timesignature: str = ""
    cot_duration: float | None = None
...
def _update_metadata_from_lm(
    ...
    caption: str,
    lyrics: str,
) -> tuple[int | None, str, str, float | None, str, str, str]:
...
def generate_music(
    ...
    try:
        ...
        for idx, dit_audio in enumerate(dit_audios):
            ...
            seed_list[idx] if idx < len(seed_list) else seed_list[0] if seed_list else -1
